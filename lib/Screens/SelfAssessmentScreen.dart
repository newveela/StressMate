...
import 'package:stressmate/Screens/QuizPage.dart';
import 'package:stressmate/Screens/Prediction.dart'; // Import the Prediction screen
...
class _AssessmentState extends State<Assessment> {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                width: 0.90 * width,
                child: Image(
                  image: AssetImage('assets/girlpic.jpg'),
                ),
              ),
              ...
              buildTestTile('Depression', depression, 8, 'Depression',
                  [Colors.blue, Colors.greenAccent]),
              SizedBox(height: height / 60),
              buildTestTile('Anxiety', anxiety, 7, 'Anxiety and stress',
                  [Colors.red, Colors.pinkAccent]),
              SizedBox(height: height / 60),
              buildTestTile('PTSD', pstd, 5, 'PTSD', [Colors.cyan, Colors.teal]),
              SizedBox(height: height / 60),
              buildTestTile('Schizophrenia', schizophrenia, 8, 'Schizophrenia',
                  [Colors.purple, Colors.indigo]),
              SizedBox(height: height / 60),
              buildTestTile('Addiction', addiction, 6, 'Addiction',
              ...
              InkWell(
                child: ListTile(
                  title: Center(
                    child: Text('Stress Prediction', style: style),
                  ),
  ...
  Widget buildTestTile(
      String title, List<String> questions, int count, String type, List<Color> colors) {
    return InkWell(
      child: ListTile(
        title: Center(child: Text(title, style: style)),
        tileColor: Colors.grey[100],
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(15),
          side: BorderSide(color: Colors.black, width: 1),
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => QuizPage(questions, count, type, colors),
          ),
        );
      },
    );
